    ...
    <div class="container-fluid main-content see-submission">
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <div class='checkbox'>
                            <label for="">
                                <input type='checkbox' id='niec-automaticamente' />Atribuir NIEC Automaticamente
        ...
        <div class='row'>
            <div class='submission-button-controls col-md-12'>
                <a href='#' class='btn btn-primary'>Salvar e Avançar</a>
            </div>
        </div>
    </div>
...
<script>
    $(function(){
        $("#niec-automaticamente").click(function(){
            $("#niec-manual").toggle();
            /*if($("#niec-automaticamente").is(":checked")) {
            } else {
                $("#niec-manual").show();
            }*/
        });
