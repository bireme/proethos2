...
<?php include 'header.php'; ?> 
    ...
    <div class="container-fluid main-content see-submission">
        ...
        <div class='block action'>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <h2 class='sub-header'>Reunião:</h2>
                </div>
            </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group" id='rejeitar-group'>
                        <label for="">Selecionar a reunião:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <select class='form-control selectpicker' data-live-search="true">
                            <option></option>
                            <option>15/04/16 - Reunião de pauta tal</option>
                            <option>18/04/16 - Reunião de pauta diferente</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class='row'>
            <div class='submission-button-controls col-md-12'>
                <a href='#' class='btn btn-primary'>Associar Reunião</a>
            </div>
        </div>
    </div>
