...
<?php include 'header.php'; ?> 
    ...
    <div class="container-fluid main-content see-submission">
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Enviar draft opinion:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
        ...
        <div class='block'>
            <div class='row'>
                <div class="col-md-12">
                    <h2 class='sub-header'>Revisão Interna:</h2>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class='form-control'>
                            ...
                            <option>Aprovação Condicional</option>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Validez Científica:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <textarea class='form-control' rows="4"></textarea>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Selección justa de participantes:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <textarea class='form-control' rows="4"></textarea>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Balance favorable de beneficios y riesgos:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <textarea class='form-control' rows="4"></textarea>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Consentimiento informado:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <textarea class='form-control' rows="4"></textarea>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Respeto por los participantes:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <textarea class='form-control' rows="4"></textarea>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Otros comentarios:</label> 
                        <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                        <textarea class='form-control' rows="4"></textarea>
                    </div>
                </div>
            ...
            <div class='row'>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class='form-control'>
                            <option></option>
                            <option>Acompanhamento Semestral</option>
                            <option>Acompanhamento Anual</option>
                            <option>Final da Pesquisa</option>
                            <option>N/A</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <div class='checkbox'>
                            <label for="">
                                <input type='checkbox'> Decisão Final
                                <a href='#' data-toggle="modal" data-target="#modal-help"><i class='glyphicon glyphicon-question-sign'></i></a>
                            </label> 
                        </div>
                    </div>
        ...
        <div class='row'>
            <div class='submission-button-controls col-md-12'>
                <a href='#' class='btn btn-primary'>Salvar Parecer</a>
            </div>
        </div>
    </div>
